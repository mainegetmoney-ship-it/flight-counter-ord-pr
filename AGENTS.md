...
3. Keep the browser storage key `ord_pr_flight_tracker_v1` unchanged unless the user explicitly approves a migration.
...
6. Keep `AGENT_HANDOFF.md` updated whenever features, architecture, routes, or deployment behavior change.
7. Use GitHub for source control and Firebase Hosting for test and production deployments.
8. Never commit Firebase service account JSON, Firebase tokens, or other credentials to the repository.
